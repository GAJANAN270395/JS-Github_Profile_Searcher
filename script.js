const fetchGithubUser = async () => {
  ...
  if (data.message == 'Not Found' || username.value.length == 0) {
    errorMsg.style.display = 'block';
    alert(data.message);
  } else {
    let displayBlock = document.getElementById('userDetails');
...
searchButton[0].addEventListener('click', fetchGithubUser);
